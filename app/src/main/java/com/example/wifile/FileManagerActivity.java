...
<<<<<<< HEAD
    ...
    public class CheckAdapter extends ArrayAdapter<String> {
        ...
        //Need a method to display the checkboxes as checked?
        //When a checkbox is checked, rowChecked()
    ...
    public void finish()
    {
        ...
        //send all filenames to writeToFile()
         for(int i =0; i < checkAdapter.checkStates.size();i++)
         {
             if(checkAdapter.checkStates.get(i)== true)
